...
test('getCommitLink', () => {
  ...
  expect(testee.getCommitLink(data, data.branches[0].commits[0])).toBe("http://gitlab.intranet.huiyin.com/matrix/matrix-ui-new/commit/testhash9603a3ca6e6c8b486cbaff759975cf50");
});
...
test('findCutoffFromTs', () => {
  ...
  expect(testee.findCutoffFromTs(beijingTodayTwentyThree)).toBe("08:00:00 Wed | 2019 May 01 | +0800");
  expect(testee.findCutoffFromTs(beijingYesterdayTwentyThree)).toBe("08:00:00 Tue | 2019 Apr 30 | +0800");
});
